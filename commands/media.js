...
const tvideo = await fetchJson(`https://saipulanuar.ga/api/download/ytmp4?url=${anu.url}&apikey=APIKEY`)
             
const videolink = tsong.download

            citel.reply (`*Download Your Video_*`);
...
const audiolink = tsong.download
            ...
            citel.reply (`*Download Your testsong*`);
            citel.reply (`*Upload Your testsong*`);
